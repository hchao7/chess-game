...
class TestPlayChessGameMethod(unittest.TestCase):
    ...
    def test_invalid_move(self):
        # 1: Player first enters invalid move and must re-enter move
        # Enter moves
        # WHITE: d2/d3/x
        # BLACK: g8/g5/x (Should repeatedly ask for valid move), g7/g6/x
        game = ChessVar()
        play_chess_game(game)
        board = game.get_board().get_board_display()
        post_game_display = [
            ...
            ['1', 'R', 'N', 'B', 'Q', 'K', 'B', 'N', 'R'],
            [' ', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']]
        self.assertEqual(board, post_game_display)

    def test_invalid_fairy_placement(self):
        # 1: Player first enters invalid move and must re-enter move
        # Enter moves
        # WHITE: d2/d3/x
        # BLACK: b6/x/h (Should repeatedly ask for valid move), g7/g6/x
        game = ChessVar()
        play_chess_game(game)
        board = game.get_board().get_board_display()
        post_game_display = [
